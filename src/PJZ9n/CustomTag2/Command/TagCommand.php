...
class TagCommand extends PluginCommand implements CommandExecutor
{
    public function __construct(Plugin $owner)
    {
        parent::__construct("tag", $owner);
        $this->setDescription("CustomTagのフォームを開く");
        $this->setUsage("/tag");
        $this->setPermission("customtag2.command.tag");
